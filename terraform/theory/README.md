...
This command downloads the necessaryproviders and modules specified in your
configuration files.
...
It's important to note that when you initiate Terraform (terraform init),
...
You can use the count parameter to create multiple instances of a
resource based on a list:
